package com.i1314i.ourproject.utils.excel;
...
public class JavaPoiUtil {
    ...
    //Excel导出(单Sheet)
    public static  <T> Workbook createWorkBook(List<Map<String,Object>>list, String[] mapKeys, String[]colNames, int type,int rowNum,List<Map<String,Object>>newlist){
