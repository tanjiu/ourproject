...
public class NongYeShengChanZiLiaoCopy1 {
    ...
    public String toString() {
        return "NongYeShengChanZiLiaoCopy1{" +
                "shangPinId=" + shangPinId +
                ", shangpinMingcheng='" + shangpinMingcheng + '\'' +
                ", leibie='" + leibie + '\'' +
                ", guiGeDengJi='" + guiGeDengJi + '\'' +
                ", jiLiangDanWei='" + jiLiangDanWei + '\'' +
                ", price=" + price +
                ", caiBaoJiaDanWei='" + caiBaoJiaDanWei + '\'' +
                ", zhiBiaoJieShi='" + zhiBiaoJieShi + '\'' +
                ", beizhu='" + beizhu + '\'' +
                ", shijian=" + shijian +
                '}';
    }
